...
android {
    ...
    defaultConfig { applicationId="za.co.tenderhub"; minSdk=26; targetSdk=35; versionCode=1; versionName="0.1.0"; testInstrumentationRunner="androidx.test.runner.AndroidJUnitRunner"; buildConfigField("String","API_BASE_URL","\"${project.findProperty("TENDERHUB_API_URL") ?: "http://10.0.2.2:8000/api/v1/"}\""); buildConfigField("String","FIREBASE_API_KEY","\"${project.findProperty("FIREBASE_API_KEY") ?: ""}\""); buildConfigField("String","FIREBASE_APP_ID","\"${project.findProperty("FIREBASE_APP_ID") ?: ""}\""); buildConfigField("String","FIREBASE_PROJECT_ID","\"${project.findProperty("FIREBASE_PROJECT_ID") ?: ""}\""); buildConfigField("String","FIREBASE_SENDER_ID","\"${project.findProperty("FIREBASE_SENDER_ID") ?: ""}\"") }
...
dependencies {
    ...
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:1.10.1"); implementation("com.squareup.retrofit2:retrofit:2.11.0"); implementation("com.squareup.retrofit2:converter-gson:2.11.0"); implementation("com.squareup.okhttp3:logging-interceptor:4.12.0"); implementation("androidx.security:security-crypto:1.1.0-alpha06"); implementation("com.google.firebase:firebase-messaging:24.1.0")
