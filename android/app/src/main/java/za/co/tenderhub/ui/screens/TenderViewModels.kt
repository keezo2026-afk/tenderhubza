...
data class SearchResults(val items:List<Tender>,val page:Int,val totalPages:Int,val loadingMore:Boolean=false)
...
class SearchViewModel(private val repo:TenderRepository):ViewModel(){
