...
class SmtpEmailProvider:
 ...
 async def send_password_reset(self,email:str,reset_url:str)->None:await asyncio.to_thread(self._send,email,reset_url)
 def _send(self,email:str,reset_url:str):
  message=EmailMessage();message["Subject"]="Reset your TenderHub SA password";message["From"]=self.settings.smtp_from_email;message["To"]=email;message.set_content(f"Use this one-time link to reset your password:\n\n{reset_url}\n\nIf you did not request this, ignore this message.")
